                                    ...
                                    <div class="row mb-4">
                                            ...
                                            <div class="form-group @error('province_code') is-invalid @enderror">
                                                <select class="form-select" name="province_code" id="province">
                                                    ...
                                                    @foreach ($provinces as $province)
                                                        <option value="{{ $province->code }}" {{ old('province_code', $vendor->province_code) == $province->code ? 'selected' : '' }}>{{ $province->name }}</option>
                                                    @endforeach
                                        ...
                                        <div class="col-md-6 col-12 mt-3">
                                            ...
                                            <div class="form-group @error('city_code') is-invalid @enderror">
                                                <select class="form-select form-select-md" name="city_code" id="city">
                                                    
                                                    <option value="{{ $vendor->city_code }}" {{ old('city_code', $vendor->city_code) == $vendor->city->code ? 'selected' : '' }}>{{ $vendor->city->name }}</option>
                                        ...
                                        <div class="col-md-6 col-12 mt-3">
                                            ...
                                            <fieldset class="form-group @error('district_code') is-invalid @enderror">
                                                <select class="form-select form-select-md" name="district_code" id="district">
                                                    
                                                    <option value="{{ $vendor->district_code }}" {{ old('city_code', $vendor->district_code) == $vendor->district->code ? 'selected' : '' }}>{{ $vendor->district->name }}</option>
                                        ...
                                        <div class="col-md-6 col-12 mt-3">
                                            ...
                                            <div class="form-group @error('village_code') is-invalid @enderror">
                                                <select class="form-select form-select-md" name="village_code" id="village">
                                                    
                                                    <option value="{{ $vendor->village_code }}" {{ old('city_code', $vendor->village_code) == $vendor->village->code ? 'selected' : '' }}>{{ $vendor->village->name }}</option>
