                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="#" class="icon text-info" data-bs-toggle="modal"
                                        data-bs-target="#galleryModal{{ $return->id }}" data-bs-toggle="tooltip" data-bs-placement="top"
                                        title="See Photo">
                                    ...
                                    <div class="modal-dialog modal-dialog-centered modal-dialog-centered"
                                        ...
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="galleryModalTitle{{ $return->id }}">Our Gallery Example</h5>
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <img class="d-block w-100" src=" {{ $return->photo_returned }} ">
                                            </div>
